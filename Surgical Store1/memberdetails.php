...
?>
<?php
	$conn=mysqli_connect("localhost","root","","careathome");
...
if ($_SERVER["REQUEST_METHOD"]=="POST") 
{
  if(isset($_POST['username']) && !empty($_POST['username']))
  {
   ...
   $arr=array(); 
        ...
        $message = "<h3>Thankyou For Subscription ".$username."  :</h3>"; 
        $subject = "Subscribe";   
...
<div class="col-md-offset-3 col-md-9">
	...
	<input type="text" name="username" class="col-xs-10 col-sm-5" value="<?php echo $email;?>">
	</div>
</form>
<?php 
