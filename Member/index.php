...
<html>
	...
	<body>
		<div class="container">
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["surproid"]; ?>">
...
if(isset($_POST["add_to_cart"]))
{
	...
	$q="insert into tempcart(proname,memid,surproid,img,price,item_quantity,total,surgid,Isconform) value('$name','$memid','$surproid','$x','$price','$quantity','$total','$surgid','$Isconform')";			 
	// echo $q;
