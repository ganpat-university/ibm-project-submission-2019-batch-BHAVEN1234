       ...
       $row1=mysqli_fetch_array($q1);
        ...
        if( $count1>0)
        {
            ...
            try {
                ...
                $mail->Subject = 'RENT CONFORMATION';
                $mail->Body = "Hello $memfname $memlname,
                Thank your your Ordering $surproname AS Rent form CareAtHome. We’ll send a confirmation when your item will be shipped.If you would like to view the status of your order of rent  or make any changes to it, please visit Your Orders on CareAtHome
                 '>";
