													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																...
																<img style="height:200px;width: 300px;" src="../mempic/<?php echo $res['mempic']; ?>">
															...
															<a href="memberupdate.php?Id=<?php echo $res['memid'];?>" class="btn btn-sm btn-block btn-success">
														...
														<div class="col-xs-12 col-sm-9">
															<h4 class="blue">
																<span class="middle"><?php echo " ".$res['memfname']." ".$res['memlname'];?></span>
															...
															<div class="profile-user-info">
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span><?php echo " ".$res['memfname']." ".$res['memlname'];?></span>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	<div class="profile-info-name"> Diabic or Not </div>

																	<div class="profile-info-value">
																		<span><?php echo " ".$res['isdiabic'];?></span>
																	</div>
																</div>

																<div class="profile-info-row">
																	<div class="profile-info-name"> Bloodpressure or Not </div>

																	<div class="profile-info-value">
																		<span><?php echo " ".$res['bloodpressure'];?></span>
																	</div>
																</div>

																<div class="profile-info-row">
																	<div class="profile-info-name"> Smoking or Not </div>

																	<div class="profile-info-value">
																		<span><?php echo " ".$res['issmoking'];?></span>
																	</div>
																</div>
