...
<?php
	...
	// echo $todaydate;
	$fromdate=date('Y-m-d');
	$todate=date('Y-m-d', strtotime($fromdate.'+28 days'));
	// $to=date('Y-m-d', strtotime($todaydate.'+7 days'));
...
<div class="col-md-offset-0 col-md-3">
	<div class="input-group">
		<input type="date"  class="form-control date-picker" name="txt_fromdate" min="<?php echo $fromdate;?>" max="<?php echo $todate;?>">
...
<div class="col-md-offset-0 col-md-3">
	<div class="input-group">
		<input type="date"  class="form-control date-picker" name="txt_todate"  min="<?php echo $fromdate;?>" max="<?php echo $todate;?>">
		<span class="input-group-addon">
			<i class="fa fa-calendar bigger-110"></i>
		</span>
	</div>
