...
$qry="INSERT INTO medical_store(areaid,medicalstorename, contact, email, uname, pwd, dateofreg, dateofl,isactive,address,vcnt,certificate,verified,available) VALUES ('1','$medistorename','$conta','$email','$un','$pass','$doo','$doo','$isactive','$address','$vcnt','$certi','yes','yes')";
	// echo $qry;
...
<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Medical Store Name 	</label>

										<div class="col-sm-9">
											<input type="text" name="txt_name" class="col-xs-10 col-sm-5" pattern="[a-zA-Z]{2,30}" maxlength="60"> <br><br>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="txt_con"class="col-xs-10 col-sm-5" pattern="[6|7|8|9][0-9]{9}" minlength="10" maxlength="10"><br><br><br>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="email" name="txt_email"class="col-xs-10 col-sm-5" maxlength="50"><br> <br><br>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
													<input type="text" name="txt_uname"class="col-xs-10 col-sm-5" maxlength="30"><br> <br><br>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9"><input minlength="8" maxlength="20" type="password" name="txt_repwd" class="col-xs-10 col-sm-5"><br> <br><br>
										</div>
									</div>
