...
else
{
								...
								$qry="Insert into member_master(areaid,memfname,memlname,uname,pwd,doreg,dateoflv,vcnt,contact,email,issmoking,isdiabic,bloodpressure,gender,mempic,isactive,address) values('$areaid','$fn','$ln','$un','$pass','$dtofreg','$dtoflast','$vcnt','$conta','$email','$smoking','$diabetic','$Bloodpressure','$gender','$fui','$active','$address')";
								// echo $qry;
								$cnn = mysqli_connect("localhost","root","","careathome");
...
<div class="page-header">
						...
						<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Contact" class="col-xs-10 col-sm-5" name="txtcontact" maxlength="10" required="" pattern="[6|7|8|9][0-9]{9}" maxlength="10" minlength="10">
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">																	
									<select class="form-control" name="ddlc" required="">
