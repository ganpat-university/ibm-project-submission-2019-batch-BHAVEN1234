...
<a class="btn btn-white btn-warning" href="manage appointment(maharsh).php"><i class="ace-icon fa fa-reply icon-only"></i> Back</a>
...
if(isset($_POST["btnsubmit"]))
{
	...
	$memid=$_GET["Id"];
		...
		$q="update lab_appo set Isnew='$isnew',Isconform='$isconform' where memid= $memid";
		echo $q;
