...
$qrye=("select * from area_master,lab where area_master.areaid=lab.areaid");
...
<div class="media search-media">
	<div class="media-left">
		<a href="labdetalis.php?Id=<?php echo $labid;?>">
			<img class="media-object" data-src="holder.js/72x72" alt="72x72" src="img/<?php echo $ro["labpic"];?>" data-holder-rendered="true" style="width: 72px; height: 72px;">
		</a>
		</div>
