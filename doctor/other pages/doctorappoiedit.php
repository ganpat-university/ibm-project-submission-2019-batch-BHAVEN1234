...
<div class="page-header">
	...
	// $doctorlname=$_POST["txt_lname"];
		...
		$qry="update doctorappointment SET dateofappointment='$Appointmentdate',appointmenttime='$Appointmenttime',appointmentdetails='$appointmentreason' where doctorappointmentid='$doctorappoid'";
		echo $qry;
