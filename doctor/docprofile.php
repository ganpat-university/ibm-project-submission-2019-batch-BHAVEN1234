													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																...
																<img style="height:200px;width: 300px;" src="../docpic/<?php echo $res['docpic']; ?>">
															...
															<a href="doctorupdate.php?Id=<?php echo $res['doctorid'];?>" class="btn btn-sm btn-block btn-success">
														...
														<div class="col-xs-12 col-sm-9">
															<h4 class="blue">
																<span class="middle"><?php echo " ".$res['docfname']." ".$res['doclname'];?></span>
															...
															<div class="profile-user-info">
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span><?php echo " ".$res['docfname']." ".$res['doclname'];?></span>
																	</div>
																</div>
