...
$qry="select * from lab_appo,member_master where lab_appo.labid='$labid' and lab_appo.Isconform='yes' and lab_appo.memid=member_master.memid";
...
<tr>
	...
	<td style="height: 200px;width: 150px;"><center>
		<a href="memberupload.php?Id=<?php echo $row["memid"];?>"><i class="ace-icon fa fa-cloud-upload"></i> Upload Prescription To <?php echo $row['memfname'].' '.$row['memlname'];?></a><br></center>
	</td>
