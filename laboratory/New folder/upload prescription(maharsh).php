...
<tr>
	...
	<td style="height: 200px;width: 150px;"><center>
		<a href="memberdetails.php?Id=<?php echo $row["memid"];?>"><i class="ace-icon fa fa-cloud-upload"></i> Upload Prescription To <?php echo $row['memfname'].' '.$row['memlname'];?></a><br></center>
	</td>
