...
$labid=$_SESSION["labid"];
		...
		$qry="Select * from lab_appo,member_master where labid=$labid and lab_appo.memid=member_master.memid";
		echo $qry;
		$qes=$cnn->query($qry);
...
<tr>
	...
	<td style="height: 200px;width: 200px;">
		<img style="height:100px;width: 100px;" src="<?php echo 'img/'.$res['mempic'];?>">
	</td>
