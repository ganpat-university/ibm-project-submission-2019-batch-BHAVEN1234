...
<?php
		...
		// echo $memid;
		$qry="Select * from  medical_store where medistoid='15'";
		// echo $qry;
		$qes=$cnn->query($qry);
													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																...
																<img style="height:200px;width: 300px;" src="medpic/<?php echo $res['img']; ?>">
														...
														<div class="col-xs-12 col-sm-9">
															<h4 class="blue">
																<span class="middle"><?php echo " ".$res['medicalstorename'];?></span>
															...
															<div class="profile-user-info">
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span><?php echo " ".$res['medicalstorename'];?></span>
																	</div>
																</div>
